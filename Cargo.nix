...
in
{
  ...
  "unknown".aiken-lang."0.0.28" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      chumsky = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chumsky."0.8.0" { inherit profileName; };
      hex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".hex."0.4.3" { inherit profileName; };
  ...
  "unknown".aiken-project."0.0.28" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      zip_extract = rustPackages."registry+https://github.com/rust-lang/crates.io-index".zip-extract."0.1.1" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chumsky."0.8.0" = overridableMkRustCrate (profileName: rec {
    name = "chumsky";
    version = "0.8.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8d02796e4586c6c41aeb68eae9bfb4558a522c35f1430c14b40136c3706e09e4"; };
    features = builtins.concatLists [
      [ "ahash" ]
      [ "default" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.13" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.23.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".zip-extract."0.1.1" = overridableMkRustCrate (profileName: rec {
    name = "zip-extract";
    version = "0.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4c5cc0309f6e81ab96c2b43d5e935025f8732c886690be8f78f68e06bad1d274"; };
    features = builtins.concatLists [
      [ "bzip2" ]
      [ "default" ]
      [ "deflate" ]
